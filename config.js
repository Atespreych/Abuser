...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴;ʀᴀɢᷨᴀͦɴͭᴏʀᴋ;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴' : process.env.OWNER_NAME,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/SSn0JaM.jpg' : process.env.ALL_IMG.split(',')[Math.floor(Math.random()*process.env.ALL_IMG.split(',').length)],
    created_by_souravkl11: process.env.ALL_IMG2 === undefined ? 'https://i.imgur.com/SSn0JaM.jpg' : process.env.ALL_IMG2,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴|ʀᴀɢᷨᴀͦɴͭᴏʀᴋ' : process.env.STICKER_DATA,
    ...
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/DNP9Fd1eWrjKz2DalRI2CX' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
